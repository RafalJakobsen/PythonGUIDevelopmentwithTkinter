...
canvas.coords(line, 0, 0, 320, 240, 650, 0)
...
canvas.itemconfigure(rect, fill = "orange")
...
# poly = canvas.create_polygon(160, 360, 320, 480, 360, fill = "blue")
# text = canvas.create_text(320, 240, text = "Python", "Courier", 32, "bold")
# logo = PhotoImage
# image = canvas.create_image(320,240, image = logo)
# canvas.lift(text)
# canvas.lower (image)
# canvas.lower (imgage, text)
